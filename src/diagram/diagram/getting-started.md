...
{% aspTab template="diagram/getting-started/node", sourceFiles="node.cs" %}
...
{% aspTab template="diagram/getting-started/defaultvalues", sourceFiles="defaultvalues.cs" %}
...
{% aspTab template="diagram/getting-started/flowchart", sourceFiles="flowchart.cs" %}
...
{% aspTab template="diagram/getting-started/orgchart", sourceFiles="orgchart.cs" %}
